...
- `temper_demo_liability_source.py` — a demo-only upstream liability source used to create deterministic Studio demonstration receipts. It is not production liability infrastructure.
